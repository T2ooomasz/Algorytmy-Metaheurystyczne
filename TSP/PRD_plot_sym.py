...
with open('data-k-random/sym-k-random1280.csv','r') as csv_file1: #Opens the file in read mode
...
with open('data-k-random/sym-k-random-time1280.csv','r') as csv_file3: #Opens the file in read mode
...
Best = np.array([1044, 2140, 4150, 8236, 16182, 32167, 64123, 128117])
...
color = 'tab:red'
ax1.set_xlabel('Liczba miast. [Instancja symetryczna].')
